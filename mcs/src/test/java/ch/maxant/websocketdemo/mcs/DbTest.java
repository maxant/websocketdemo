...
public abstract class DbTest {
    ...
    public void setup() {
        ...
        if(useMysql){
            System.out.println("\r\n\r\nUSING MYSQL!!\r\n");
            flyway.setDataSource("jdbc:mysql://localhost:3306/websocketdemo_mcs?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=UTC", "root", "password");
        }else{
